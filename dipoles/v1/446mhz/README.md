...
<video src='https://youtu.be/QFiHPVZvDwM'/>
...
- алюм. трубки для плеч діполей (див. креслення)
...
- обидві трубки на роз'єм фіксуються невеликою кількістю цианокрилата щоб уникнути механічного пошкодження
- диполь перевіряється антенним аналізатором, порівнюється з іншими диполями, по необхідності переробляється

**_Кожен диполь має бути герметичним_**. Всі диполі мають мати фазову симетрію, що має проявлятись в т.ч. у резонансі на одній й тій самій частоті. Порядок перевірки диполів:
...
Основна причина розбіжності по частоті між діполями - різний зазор між трубками. Переконайтесь що обідві трубки торкаються стопора в корпусі, за необхідністю перепаяйте. Також завелика кількість припою на одній із трубок може вплинути на частоту резонансу.
...
- проклеюються всі стики діполя (кришка, навколо роз'єму, навколо трубок, торці трубок за необхідністю), диполь має бути повністю герметичним
